...
Circles:
	- Program creates a grid of circles where the top row and leftmost column act as a legend. The other cells of the grid trace the
		pattern created by following the legend. 
...
Pixel Puzzle Solver:
	- Program allows the user to create and solve pixel puzzles. The game is also known as a Nonogram, or PicaPix, where the user is
		presented with a blank grid, and must use hints on the vertical and horizontal axis to logically fill in the grid revealing
		a hidden picture. 
